...
In fresh water an osmoregulating fish takes up water through its sking, and actively takes up ions through its gills, It drinks lottle water , and excretes dilutes urrine 
...
NOTE: Salmon can osmoregulate in both envoronments. 
...
#### Energy consequences 
There may be an energetic cost of osmoregulation which drives smaller size in freshwater streams. (for example crayfish, although there are other explinations, such as greaeter food availability, there is more detritous available in marrian environments. ).

#### Thermoregulation 
water tends to be thermally stable (especiialy in systems with a well developed thermocline. THis means that most aquatic organisms can afford to be poikilothermic. (there body temperature is allowed to adjust passively to that of the outside environment. ). Such animals tend to be unitherms, ie they are adapted to a wide range of different temperatures. 
This is achieved through temperature compensation, there are both metabolic and behavioural techniques for mantaining body temperature. 


#### Respiration
Maximise surface area of respiratory tissue, and maximise the rate of flow of oxygenated water , (while minimising the surface area though which they can loose / gain unwated water  or salts which disrupts their osmotic ballance.). This leads to a conflict between respiration and osmoregulation, where an optimum must be reached. MOst animals are adapted to deal with this problem with gills, which differ in shape and surface area depending on the particular environment of the given organism (species). for animlas in less oxygenated water  The gill is either a big leaf shape or consists of multiple strands, 
For Baetidae and Heptageniidae which live in fast flowing oxygenated water the gill is more streamlined, and a bit smaller. Plecopteran , ventialte thier gills by flapping thier legs to increase current. 

In dragon fly larve a rectal gill is used, which allows for propulsion by sucking in and pushing out water. 
Some insects have normal insect spiracles, such insects developed adaptions such as a "breathing tank" in beeles with a subelytral cavity, abover the trachea. Bugs tend to use a with plastron hairs which trap air bubbles. some others such as mosquito larvae use what is essentially a snorkel 

### Mantenance of position in lotic waters. 
the current can often be extremely strong, this can be delt with by 

##### aviodane behaviour 
moving during floods, and in general living in sheltered areas such as behidn bolders, 
Body shap ewhich is streamlined helps as well as attatchmet morphological features for gripping onto the substrate. 

##### Body shape 
the heptageniid mayflies are extremely addapted so that they can live and feed on the surface of the rock surface, this body shape means the current pushes the insect down onto the rock, the tail is used as a rudder to stear the mayfly. 
Clays (mayflies suckers (Blepharacerideae simuliidae, or a silk cord which they attatch and can climb back up if they happen to fall off the rock.  silk nets, (hydropsychids, muscular foot, gastropds. )))

#### Lentic waters. 
As there is not flow for passive moviment, active moviment is required, howvere animals such as plankton still require at least vertical moviment for example to stay on the right side of the thermocline. 

Fish mantain there boyaney with a swim bladder, an organic attatched near the top of the spine, 
Algea have trapped gas/oil bubbles, water hyacinth have lacunae (large air filled structures within the stem. 

### Migration 
There is alot of migration ocuring in the vertical dirrection, it is still an active process, exhibited by most pelagic plankton species, generally they are in deep water in the day moving up to shallower water at night (migrating at dusk). 

Preditor avoidance during the day, such as from fish, and other visual hunting predotirs, 
energy conservation , stay warm enough that metabolsim is working without using energy to cool down, move up at night to feed on phytoplankton. 

NOTE: still dont want to be below thermocline as their is low oxygen 
(in summary, find food, dont becomes food, and regulate metabolsim). 

There are preditors withint hte phytoplankton which tend to follow their prey, such as (?) which follow copepods.

#### rivers. 

##### Drift. 
downstream transport by the current of benthic animals. It is a voluntary behavioural adaptation. 

###### CAtastrophic 
animals which are involved in catastrophic, unpredictable disturbance. 

###### Behavioural drift. 
individual organisms or small groups or organissms which all move into the water column due to a particular stimulus, ie to avoid predation or to find food. Active decision made mbased on a common dirver in the background habitat. 
Escaping from a local stress, abandonment of a substrate. drift is a very energy effecient way of moving around (compared to using muscle contractions to move along the stone. avoid attach from a preditor. Generally higher at night. trout make drif tdangerous as they sit by an area of low flow next to an area fo high flow and eat stuff coming down the high flow area, trout are visual preditors so more dangerous in the day. 

NOTE: catestrophic drinf is orders of magnitude higher than the normal level of drift sean. 
...
###### Advantages of drift. 
Works in ballance with tendancy in adults to fly upstream. which in combination drives dispersal. which helos to mediate competition for food and space. Drift can allow for rapid recolonisation after a disturbance event such as a flood. provided there is an upstream refuge area. (post flood drift. ). 

### Re[roduction and dispersal 
both sexual and assexual reproduction is seen in freshwater systems. 
In certain situations assexual reproduction is very useful as it is very rapid, has low energy cost and can easily be used to take advantage of freindly areas such as temporary ponds. (which have lots of food an d no predotors. ). the disadvantages are lwo ro no genetic variation which leads to vulnerability to population crashes and extinctions. most can do both, organisms switching to sxual production when the environment starts to change.for example males produced as stream dries up so that genetic variation in eggs produced just before the whole pond dires.  

###### Cosnant 
anminals which let go by accident or whcih just genrally drift. 


## Type of fertilisation 
Overall sexual reproduction is much more widely found than assexual reproduction 

### Broadcast spawning 
the gametes are put dirrectly into the water cloumn, and form zygotes, basically for sessile animals. 

for mobile animlas there is more active fertilisation, often in a spawning bed, in the case of salmon femal makes a Redd,  a space to lay eggs, male fertiles eggs as they are released, this is external but pocalised. 

In insects there can be internal fertilisation. 

In freshwater organisms ranges from broadcast spawning through to internal fertilization. A large protion of marrine invertibrates are sessile so rely on the water column for mixing and dispersal, this is possible in the sea becuase there are alot of strong currents allowing for mixing of gametes and dispersion of offspring to new areas. 

not so much broadcast spaning in rivers and lakes. 
In lakes because there is very little current. windreach can lead to mixing but still far less than that induced by waveaction and ocean currents. In rivers gamemts only move downstream so things dont necessarily mix properly, (ie is males produce before females all sperm are gone downstream before eggs arrive. this spawnign mechanism is optimased for rocky shores. 

## Spawning aggregations. 
strongly linked to season, temperature and flow. (slelecting parts of the habitat which are ideal fpr oncubating eggs))
female finds good bolder releases pherhormone all males in the water come behind he, lays eggs in small bunches which stick to rocks, males all pile in to try and lay release their sperm. some males come right up to touch the females, ignore other things in their environment. scavangers will try and eat loose eggs which come past in the water column. In a big spawning aggregation individual chances of being picked off by a preditor are lower. 

Competition for successful copulation / fertilisation 
mating territories (e.g. odonates) defend /competed for by males, females entering this territory will be courted. the male who mates with the female last is most likely to pass on his genetic information. engage in mate garding, male hangs onto female to prevent her from mating with other females. mating aggregations in insects also occur, which are characterised by synchronised appearance and swarming. many groups emmerge on ms most classically mayflies. Some mayflies lilve only 24 hours as adults, so emmerge mate and die. mating aggregations tend to focus around land marks for example caddis flies around a particular tree. mating swarms maximises the opportunity for all different organisms to find a mate. generally all males, deceases interspecies competition, ensures contant between sexes. territories vs aggregation is to an extent species vs individual. leads to high increased preditor attraction but still overall risk of individual predation risk is decreased. 

Dispersal of eggs tends to be done upstream of of eggs spawnign sites. In the case of freshwater systems eggs are generally layed on rockes, sometimes vegitation, in lentic systems there are not many rockes so eggs are normally layed on marcophytes at the edge of the stream, or on rafts which float on the surface of the water. 

Overall reproductive strategy 
r vs k selection 

## R selection 
many small, insects. In general r selection is most common in fish insects and crustaceans for freshwater systems, generally more eggs/young produced by planktonic forms than marco-invertibrates, which tend to lay small batches, several baaches in ifferent places but still overall less eggs. 

## K selection 
fewer larger eggs. cylincoid fishes from lake malawe, mouth brouders <100 about 20, eggs at a time.  

### Population dynamics of the system. 
Organisms compete amoungst eachother and with other specie for limited reasources. When there are plentiful resources there is rapid increase in population size. A mismatch between resources and consumers will resul in population losses through one of two routes. mortality and dispersal. the number of fish in a given region of stream may flucuate, and increasing because of increased resources, and then droping beacuse of dying of moviment to avoid competition. 
COPY IMAGE. 

the overall birthrate in the population will decline as resources decline, one birthrate and mortality are equal a ballancing point is reached which is the carrying capacity of a particular habitat. Intraspecific competition for stable limited resources means populations will be kept below a stable threshold maximum. 
depending on the rate of resource distribution change die offs and increases may be more ofr less dramatic, emerging adult blackflies disperse at higher rate id the local population density of larvae is too high. COPY IMAGE>  such dispersal patterns are found in fish as well as in macroinvertibrates, fish however because of their ssize have a lot more requirements in terms of ideal environments for spawnign, (COPY IMAGE). For example in particular season water temperture, fall to the right range and all fish moved up to particular places along the river, larvae drift down stream to go into shallow backwaters, safe from preditors, but with lots of food. 

verwintering, rivers free over, so ifsh must fidn thermaal refuges in the winter, in SA fish will find optimum habitats for feeding and for predation risk, daily or sseasonal migration between refuge and feeding habitat occurs in a single reach. In effemeral, or temportal rivers, source sink dynamics are seen, for a serious of pools in an intermittent stream, fish move between refuge pools and pools whcih dry up in dry season, so constant reshuffling, reproduction and overwintering in resource habitatis. refuge habitats would change from year to year. so fish reorganise depending onthe season and water . temperary habitats are sinks as they do not have the possibility to sustain a fish for a long time, so there is a moviment between source and sink habitats. expand from permanently wetted refugia into temporarily wetted sink habitats. fish populations in temporary systems are a good indication of expandi (resources in the source pools will fluctuate with varying population levels). 

### Adapting to life without water    
many lentic and lotic environments are naturally episodic or intermittent nontheless aquatic organisms still thrive in these systems, and adapt by evolving resistaance to desiccation and/or resilience to habitat loss. 

there are many temporarity which can form cysts, such as fairy shrimp, the eggs are risistance to dsessication not the adults. flexibe reproductive strategy, resistanct cysts or eggs, resitant immature /adult stages (low metabolci state, moist membrane ). exacpe by flight (isects whith flying adults)/ burrowing (hand out in the ground water, such as certain species of tapapia. ). rapid re-colonisation (resilience ) 

Wet phases can also be hrssh, such as catastrophic flood, use hypoheos, during floods. burrowing can be used to survive both drying out and flooding. burrowing into the hyperheos. Lungs fish is extremely drought resistant. Aas the wtaer level falls lungfish burrow into the bottom nu to form a cocoon and aestivate through the dry season. estivating asas an adult is an extreme drought resistance adaptation. Killifish tend to live in temporary ponds, lay drouwght resistance eggs or cysts in sediment of drying ponds, awhich hatch when water returns Killifish (_Northobranchius _) lay aestivating eggs. 

## animal ecology  in fresh water systems. competition and adaptation, aquati corganisms caray in theri abilities to self regulate and survive environmental vaariablilty.  This variable adaptation among species have different strategies to cope with environment predators, and compeditirs. becueas of theses varying adaptations and strategies there re sspecific environmental conditions in whcihc a species is able to sustain a population which is known as a niche. 


### Fundamental niche. 
the full potential set of environmetal conditions a species could survive in, given no competition. however all organisms have to compete with other similar organims so the loser o the competition get shrunk into a smaller subst ie the realsised niche, 

### Realised Niche.
the actual sub-set of these envronmentsal conditions in whcihc the species is observed to survive, given real levels of competition with other species. 

shifts between fundamental niches happen on evolutionary time scales. for example two groups of stickelbacks in the columbian glacial lakes. during the last ice age there were expansions and contrations which moved lakes and rivers, driving potential speciation, hence there were multiple invasions of lakes by stikel backs (which are river fish). subsiquent invaders had to compete with the sticke backs already there, overtime theses groups shifted their undamnetcal niches away from eachtoher overtime evolved a limnetic form , and a benthic form shifts in fundamnetal phyisical biology, such as number of gill rackers in the body (note when there are two species the range of physiological characteristics of each are confined to a smaller  )range, longer gill rackers in limnetic fish feeding on plankton. the most extreme example of speciation and niche differetiation is the malawe fish. (cillonlids.)

### Community as a whole 
disturbance in structuring freshwater communitues, community structure can be described as being controlled by two interacting forces. 

competition and disturbance, if competition dominates community structure., such as lakes like malawe of britich columbiaa, the commnity i deterministic aas the proces of niche differentiation is very predictable 

whereas if the community is disturbance driven a stochastic, ie randomly organised community results, intermediate levels of river bed disturbance supports highest benthic diversity. Animals which are highly resistant or resiliant tend to dominate in very high disturbance species, In communities with both disturbance andd competition there are the most species whihth resistance and resilinat colonises and compeditive species. INtermediate levels of river bed disturbance support highest benthic diversity (COPY IMAGE) Intermediate distrubance hypothesis. 

the relationship between disturbacen and productivity can also be compared, (COPY IMAGE). When there is very little food available/ low productivity there will always be low diveristy even with high disturbane, as porductivity increases the effect of distrubance is far more pronouced with intermediary disturbance levels leading to high diveristy.
if disturabnce is low animas like snails which are portected and good at feeding dominate, at high distrubaance snails are not very mobile so mobile generalist resilent species tend to dominate, both will co-occur at intermediary levles. 

Predation as distrubance. 
Blugill sunfish in American streams. rapid spawning allows rapid expansion of blue gill populations the intensity of the blue gill as a mortality source to its prey leads to variation in theri impact, (on macroinvertibrates). By feeding on abundant prey such species act to mediatediversity by controlling compeditively dominant species. disturbance can have a nock on effect on preditors and their ability to mediate prey. for example trout are very effeient preditors, so will wipe out local fish (galaxiids) if they reach a certain minimum population size, however trout are far less resilent to flooding, . the bed stability can be used as a indication of which species will be present in very stable beds, (low flood distrubance, ) trout only, conversely in low bed stability, high flooding only galzxiids, and in intermediary levels there is cooccurance. In general co-occurance is more frequeny in disturbed streams. 

predatory exclusion limited to stabel streams. 
